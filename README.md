...
Make sure [jupyter](https://docs.jupyter.org/en/latest/install.html) command is installed and available on your path. Do not modify the HTML documents, which will be generated by the pre-commit hook. Install it by running:
```
